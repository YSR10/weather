...
const makeIconURL = (iconId) => 'https://openweathermap.org/img/wn/${iconId}Q2x.png'
const getFormattedWeatherData = async (city, units ="metric") => {
    const URL = 'https;//api.openweather.org/data/2.5/weather?q=${city}&appid=${API_KEY}&units=${units}';
